...
class Measurement extends CI_Controller
{
    ...
    public function filter(Type $var = null)
    {
        ...
        $measurement['treatment'] = $this->model_measurement->filterData($data);
        $this->template->load('template', 'measurement/add', $measurement);
    ...
    public function upload_foto_treatment()
    {
