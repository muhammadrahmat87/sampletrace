            ...
            ?>
                ...
                <div class="form-group">
                  ...
                  <label class="col-sm-2 control-label">Urgensi</label>
                      <div class="col-sm-2">
                      <select name="urgensi" class="form-control" type="text" readonly>                   
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
					   <?php
                          echo form_dropdown('jenis', array('LSU'=>'LSU'), null, "class='form-control' readonly");
                        ?>
                </div>
                </div>
		        ...
		        <!-- <div class="form-group">
				  ...
				  <div class="form-group">
              <label class="col-sm-2 control-label">Upload Berkas (.xlxs)</label>
				      <div class="col-sm-2">
                  ...
                  <label class="col-sm-2 control-label"></label>
                      <div class="col-sm-4">
                        <button type="submit" name="submit" class="btn bg-olive">Kirim</button>
				                  <?php
                          echo anchor('registrasi', 'Back', array('class'=>'btn btn-default'));
                          ?>
                      </div>
                </div>
