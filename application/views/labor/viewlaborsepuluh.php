...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
          ...
          <h3 class="box-title">Statistic & Graph - Laboratory 5-10cm</h3>
                    ...
                    <table id="exampl" class="table table-striped table-bordered table-hover table-full-width dataTable   dt-responsive nowrap"
                      ...
                      <thead>
                        <tr class="bg-success">
                         ...
                         <th rowspan="2" width="5%"><center>pH_0-10</th>
						  <th rowspan="2" width="5%"><center>C-Org_0-10</th>
						  <th rowspan="2" width="5%"><center>N-Total_0-10</th>
						  <th rowspan="2" width="5%"><center>C/N_0-10</th>
						  <th rowspan="2" width="13%"><center>P total_0-10</th>
						  <th rowspan="2" width="13%"><center>K total_0-10</th>
						  <th rowspan="2" width="5%"><center>KTK_0-10</th>
						  <th rowspan="2" width="5%"><center>Mg_0-10</th>
						  <th rowspan="2" width="5%"><center>Ca_0-10</th>
						  <th rowspan="2" width="13%"><center>P Bray_0-10</th>
						  <th rowspan="2" width="5%"><center>K_0-10</th>
						  <th rowspan="2" width="10%"><center>Na_0-10</th>
						  <th rowspan="2" width="10%"><center>H-Tkr_0-10</th>
						  <th rowspan="2" width="13%"><center>Al-Tkr_0-10</th>
								</tr>
                      </thead>
...
<script>
  ...
  function getFilter() {
    $.ajax({
      type: "POSt",
      url: url + "Chartlaborsepuluh/filterSelect",
      data: "data",
      dataType: "JSON",
  ...
  function getValue(value, field) {
    ...
    $.ajax({
      type: "POST",
      url: url + "Chartlaborsepuluh/index",
      data: {
        value: value,
        field: field,
      },
  ...
  function showTableHabitat(response) {
    ...
    response.data_chart.detail.forEach(element => {
      html += ` <tr>
                      ...
                      <td>` + element.ph10 + `</td>
                      <td>` + element.c10 + `</td>
                      <td>` + element.n_tot10 + `</td>
                      <td>` + element.cn10 + `</td>
                      <td>` + element.p_tot10 + `</td>
					  <td>` + element.k_tot10 + `</td>
					  <td>` + element.ktk10 + `</td>
					  <td>` + element.mg10 + `</td>
					  <td>` + element.ca10 + `</td>
					  <td>` + element.pbray10 + `</td>
					  <td>` + element.k10 + `</td>
					  <td>` + element.na10 + `</td>
					  <td>` + element.htkr10 + `</td>
					  <td>` + element.altkr10 + `</td>
...

      {
        ...
        datasets: [

          {
            ...
            data                  : data.data_chart.data.a_ph10
          },
          
          {
            label                 : 'C-Org_0-10',
            backgroundColor       : '#f103a33',         
            data                  : data.data_chart.data.a_c10
          },
          {
            label                 : 'N-Total_0-10',
            backgroundColor       : '#7d10f06',         
            data                  : data.data_chart.data.a_n_tot10
          },
          {
            label                 : 'C/N_0-10',
            backgroundColor       : '#d6a30d',         
            data                  : data.data_chart.data.a_cn10
          },
          {
            label                 : 'P total_0-10',
            backgroundColor       : '#838a08',         
            data                  : data.data_chart.data.a_p_tot10
          },
		  {
            label                 : 'K total_0-10',
            backgroundColor       : '#e6f20a',         
            data                  : data.data_chart.data.a_k_tot10
          },
		  {
            label                 : 'KTK_0-10',
            backgroundColor       : '#37710010',         
            data                  : data.data_chart.data.a_ktk10
          },
		  {
            label                 : 'Mg_0-10',
            backgroundColor       : '#6de60b',         
            data                  : data.data_chart.data.a_mg10
          },
		  {
            label                 : 'Ca_0-10',
            backgroundColor       : '#04662f',         
            data                  : data.data_chart.data.a_ca10
          },
		  {
            label                 : 'P Bray_0-10',
            backgroundColor       : '#10e86f',         
            data                  : data.data_chart.data.a_pbray10
          },
		  {
            label                 : 'K_0-10',
            backgroundColor       : '#046987',         
            data                  : data.data_chart.data.a_k10
          },
		  {
            label                 : 'Na_0-10',
            backgroundColor       : '#0cb8eb',         
            data                  : data.data_chart.data.a_na10
          },
		  {
            label                 : 'H-Tkr_0-10',
            backgroundColor       : '#620663',         
            data                  : data.data_chart.data.a_htkr10
          },
		  {
            label                 : 'Al-Tkr_0-10',
            backgroundColor       : '#f1007f7',         
            data                  : data.data_chart.data.a_altkr10
          },
