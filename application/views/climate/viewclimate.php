                    ...
                    <table id="exampl" class="table table-striped table-bordered table-hover table-full-width dataTable"
                      ...
                      <thead>
                        <tr class="bg-success">
                          ...
                          <th width="29%">Soil Humidity</th>
                          <th width="29%">Soil temperature</th>
                          <th width="29%">Rainfall during instalation</th>
...
<script>
  ...
  function getFilter() {
    $.ajax({
      type: "POSt",
      url: url + "Chartclimate/filterSelect",
      data: "data",
      dataType: "JSON",
